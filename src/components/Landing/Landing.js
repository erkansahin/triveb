...
import './Landing.css';
import Kwizz from '../../Assests/triveb.png'
            ...
            <div className='component-container' >
                    ...
                    !this.state.toggle
                        ...
                        <div className='landing-wrapper' >
                            ...
                            <div className='player-input-wrapper' >
                                <input type='number' value={this.state.pin} placeholder='PIN' onChange={this.handleInput} className='input-user' />
                ...
                <div className='logo-host' >
                    ...
                    <div className='btn-host' >
                        <a id='atag' href='http://localhost:3000/#/host/newQuiz'>HOST</a>
                    </div>
                </div>
            </div>
        )
